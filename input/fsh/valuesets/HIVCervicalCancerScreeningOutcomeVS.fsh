ValueSet: HIVCervicalCancerScreeningOutcomeVS
Title: "HIV - Cervical cancer screening outcome value set"
...
* ^experimental = false
* ^version = "1.0.0"
* codes from system HIVCervicalCancerScreeningOutcomeCS
